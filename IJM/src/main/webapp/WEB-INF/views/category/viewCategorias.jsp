...
<html>
    <head>
        ...
        <script type="text/JavaScript" src="../js/controladores/general.js?v=1"></script>
        <script type="text/JavaScript" src="../js/controladores/categorias.js?v=1"></script>
        <link href="../css/lib/bootstrap.min.css" rel="stylesheet">
        <link href="../css/estilos/general.css?v=1" rel="stylesheet">
    </head>
    <body>
